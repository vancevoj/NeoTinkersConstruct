...
public class EntityMeltingRecipe implements ICustomOutputRecipe<IEntityMeltingContainer> {
  ...
  @Deprecated
  @Override
  public boolean matches(IEntityMeltingContainer inv, Level worldIn) {
    return false;
  }
}
